...
\section{Education} \vspace{-1em} \begin{outerlist}
    \item[] PhD, Fisheries and Wildlife, \href{ http://www.canr.msu.edu/fw/}{\textbf{Michigan State University}}%
            \hfill \textbf{2016 to 2020} \hspace{1em}
    \end{outerlist}
    
\begin{outerlist}
    \item[] MS, Marine Science, \href{https://www.utexas.edu/}{\textbf{University of Texas at Austin}}%
            \hfill \textbf{2009 to 2012} \hspace{1em}
    \end{outerlist}
    
\begin{outerlist}
    \item[] BS, Marine Science, \href{https://www.maine.edu/}{\textbf{University of Maine}}%
...
\begin{outerlist}
    \item[] Research Scientist, \href{https://www.sfwmd.gov/}{\textbf{South Florida Water Management District}} \hfill \textbf{2012 to 2016}
    \vspace{-0.4em}
    % \item[] \textit{Water quality modelling, data curation, and GIS tool development.}%
\end{outerlist}

\begin{outerlist}
    \item[] Research Technician, \href{https://utmsi.utexas.edu/staff/dunton/}{\textbf{University of Texas Marine Botany Lab}} \hfill \textbf{2008 to 2009}
    \vspace{-0.4em}
...
\section{\href{https://github.com/jsta}{Software and Package Development} \tiny{(See \underline{\href{https://jsta.rbind.io/openscience/}{Open Science Portfolio}}})}
