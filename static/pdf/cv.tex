...
\begin{outerlist}
    ...
    \vspace{-0.4em}
    \item[] \textit{Laboratory nutrient assays, seagrass and salt marsh surveys, piloting small boats.}%
...
\item[] 
    \begin{innerlist}
        \item Taught a workshop on version control software (Git) for application in academic research. Apr 28 2017. EEBB Programming Group.
        \item Taught a workshop on the basics of Python and the Linux command line for research computing. Jan 12 2017. Institute for Cyber-enabled Research.
    \end{innerlist}
