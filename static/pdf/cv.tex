...
\begin{bibenum*}
    ...
    \item Rougier NP, Hinsen K, <34 alphabetical authors>, \textbf{Stachelek J}, <8 alphabetical authors> (2017) Sustainable computational science: the ReScience initiative. \emph{PeerJ Computer Science}. 3:e142 \url{https://doi.org/10.7717/peerj-cs.142}.
...
\begin{bibenum*}
  ...
  \item \textbf{Stachelek J.}, Ford, C., Kincaid, D., King, K., Miller, H, and Nagelkirk, R. (\emph{accepted}). The National Eutrophication Survey: lake characteristics and historical nutrient concentrations, \emph{Earth Syst. Sci. Data Discuss.}, \href{https://doi.org/10.5194/essd-2017-52}{10.5194/essd-2017-52}.
