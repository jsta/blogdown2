...
\item Hanson, P. Stillman, A.B., Jia, X., Karpatne, A., Hilary A Dugan, H.A., Carey, C.C., \textbf{Stachelek, J.}, Ward, N.K, Zhang, Y., Read, J.S., Kumar, V., In Press. Predicting lake surface water phosphorus dynamics using process-guided machine learning. \emph{Ecological Modelling}

\item \textbf{Stachelek, J.}, Weng, W., Carey, C.C., Kemanian, A.R., Cobourn, K.M., Wagner, T., Weathers, K.C., Soranno, P.A., In Press. Granular measures of agricultural land-use influence lake nitrogen and phosphorus differently at macroscales. \emph{Ecological Applications}
