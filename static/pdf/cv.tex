...
\href{http://www.fw.msu.edu/}{\textbf{Michigan State University}},
East Lansing, MI
\begin{outerlist}
    \item[] \textit{PhD, Fisheries and Wildlife}%
            \hfill \textbf{Aug 2016 to Present}
            \begin{innerlist}
                \item Advisor:
...
Austin, TX
\begin{outerlist}            
    \item[] \textit{MS, Marine Science}%
            \hfill \textbf{Aug 2009 to May 2012}
            \begin{innerlist}
                \item Advisor:
...
\begin{outerlist}
    \item[] \textit{BS, Marine Science}%
            \hfill \textbf{Aug 2004 to May 2008}
            \begin{innerlist}
                \item Advisor:
...
\begin{outerlist}
    \item[] \textit{Research Scientist}%
            \hfill \textbf{May 2012 to Aug 2016}
            \begin{innerlist}
                \item Supervisor:
                        \href{https://my.sfwmd.gov/portal/page/portal/watershed_everglades_publications/ever_watershed_sklar}%
                             {Fred Sklar}
              \item Water quality modelling, curating environmental databases, and developing custom GIS visualization tools for water management.
            \end{innerlist}
\end{outerlist}

\vspace{1em}

\href{http://www.utmsi.utexas.edu/staff/dunton/}{\textbf{University of Texas Marine Botany Lab}},
Port Aransas, TX
\begin{outerlist}
    \item[] \textit{Technician}%
            \hfill \textbf{Aug 2008 to Aug 2009}
            \begin{innerlist}
                \item Supervisor:
                        \href{http://www.utmsi.utexas.edu/staff/dunton/}%
                             {Professor Ken Dunton}
              \item Laboratory nutrient assays, seagrass and salt marsh surveys, piloting small boats.
            \end{innerlist}
\end{outerlist}
...
\begin{bibenum*}
 ...
 \item Nicolas P. Rougier, Konrad Hinsen, <34 alphabetical authors>, \textbf{Stachelek J.}, <8 alphabetical authors> (\emph{in-review}) Sustainable computational science: the ReScience initiative. \emph{Proceedings of the National Academy of Sciences}. \url{https://arxiv.org/abs/1707.04393}.

  \item \textbf{Stachelek J.}, Ford, C., Kincaid, D., King, K., Miller, H, and Nagelkirk, R. (\emph{in review}). The National Eutrophication Survey: lake characteristics and historical nutrient concentrations, \emph{Earth Syst. Sci. Data Discuss.}, \url{https://doi.org/10.5194/essd-2017-52}.

    \item Soranno P.A., <62 alphabetical authors>, \textbf{Stachelek J.}, <15 alphabetical authors>. (\emph{in-review}) LAGOS-NE: A multi-scaled geospatial and temporal database of lake ecological context and water quality for thousands of U.S. lakes. \emph{Gigascience}.
  
    \item Park, S.R., \textbf{Stachelek, J.}, Dunton K.H., (\emph{in-review}) Photosynthesis and drought resilience in three emergent vascular plant species common to marshes of the western Gulf of Mexico. \emph{Estuaries and Coasts}.
   
    \item \textbf{Stachelek J.}, Madden, C.J., Kelly, S.P, Blaha, M. (\emph{in-review}). Fine-scale relationships between phytoplankton abundance and environmental drivers in Florida Bay, USA. \emph{Estuaries and Coasts}.
   
   \item \textbf{Stachelek J.}, Kelly, S.P, Sklar, F., Coronado, C.M., Troxler, T., Bauman, L. (\emph{in-review}). A mesocosm design for simulating sea-level rise associated saltwater intrusion in coastal wetlands. \emph{Methods in Ecology and Evolution}.
   
   \item Hollister J., \textbf{Stachelek J.} (\emph{in-review}) lakemorpho: Calculating lake morphometry metrics in R. \emph{F1000Research}.
...
\begin{bibenum*}
  ...
  \item Collins, S.M, Cheruvelil, K.S., Fergus, C.E., Lapierre, J.F., Oliver, S.K., Scott, C.E., Skaff, N.K., Soranno, P.A., \textbf{Stachelek, J.}, Tan, P., Yuan, S. and Wagner, T. 2017. Which measures of climate are the best predictors of lake water quality at sub-continental scales? Ecological Society of America Meeting, Portland, Oregon, USA. Aug 06 2017.

  \item Nowosad, J. Teucher A., \textbf{Stachelek, J.}, Cotton, R. Vitolo, C. 2017. The State of Data on CRAN: Discovering Good Data Packages. rOpenSci Unconference, Los Angeles, CA, USA. May 26 2017.

  \item \textbf{Stachelek, J.} 2017. Lake Connectivity Effects on Phosphorus in 1,000s of Lakes. Michigan State University Fisheries and Wildlife Graduate Research Symposium. Feb 24 2017.
...
\item[] \textit{Instructor}
    ...
    \begin{innerlist}
        ...
        \item Lesson Mainainter, (2015 - present), \href{http://www.datacarpentry.org/lessons/}{Geospatial Data Analysis with R}. Data Carpentry. 
    \end{innerlist}
...
\item[] \textit{Teaching Assistant} for Introduction to Oceanography
    ...
    \begin{innerlist}
        \item Taught lectures, admininstered laboratory practicals, marked assignments and exams.
    \end{innerlist}
...
\item Provided comments for: Soranno, P., King, K., Poisson, A., \textbf{Stachelek, J.}, Boudreau, C., Skaff, N., Smith, N. (2017) Cyberinfrastructure support for collaboration and open science in ecology. NSF Request for Information on Future Needs for Advanced Cyberinfrastructure to Support Science and Engineering Research \href{https://www.nsf.gov/cise/oac/ci2030/pdf/RFI-Soranno-261.pdf}{https://www.nsf.gov/cise/oac/ci2030/pdf/RFI-Soranno-261.pdf}

\item Particpated in NEON spatio-temporal hackathon (2015) - developed tutorials and assessment instruments to teach fundamental big data skills needed to work efficiently with large spatio-temporal data using open tools, such as R and Python. \href{http://www.neoninc.org/updates-events/update/nsf-biocenters-unite-close-scientific-data-skills-gap-focus-phenology}{link}
...
\begin{innerlist}
 ...
 \item \href{https://en.wikipedia.org/wiki/Wikipedia:WikiProject_Lakes}{WikiProject Lakes}. Apr 07 2017 - Present. \href{https://en.wikipedia.org/wiki/Special:Contributions/Jst4}{Contributor}
