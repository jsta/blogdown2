---
title: Interpreting the new Ecological Society of America Open Science policy
author: ~
date: '2021-02-28'
...
Access databases and raster ESRI geodatabases require paid software to open and are both technical **and** practically proprietary. Conversely, [shapefiles are technically proprietary](https://en.wikipedia.org/wiki/Shapefile) but they are not practically proprietary. The format has an open specification so as to not require paid software. As an aside, I recommend Geopackages rather than Shapefiles to be technically non-proprietary ([see prior post](https://jsta.rbind.io/blog/2016-07-14-geopackage-r/)).
